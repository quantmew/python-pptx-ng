...
class DescribeCT_GroupShape(object):
    ...
    def CT_GraphicalObjectFrame_(self, request, graphicFrame_):
        CT_GraphicalObjectFrame_ = class_mock(
            request, "pptx_ng.oxml.shapes.groupshape.CT_GraphicalObjectFrame"
        )
    ...
    def CT_Picture_(self, request, pic_):
        CT_Picture_ = class_mock(request, "pptx_ng.oxml.shapes.groupshape.CT_Picture")
        CT_Picture_.new_pic.return_value = pic_
        return CT_Picture_

    @pytest.fixture
    def CT_Shape_(self, request, sp_):
        CT_Shape_ = class_mock(request, "pptx_ng.oxml.shapes.groupshape.CT_Shape")
