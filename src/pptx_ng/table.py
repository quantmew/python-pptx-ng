...
from pptx_ng.oxml.table import TcRange
from pptx_ng.shapes import Subshape
from pptx_ng.text.text import TextFrame
from pptx_ng.util import Emu, lazyproperty

if TYPE_CHECKING:
    from pptx_ng.enum.text import MSO_VERTICAL_ANCHOR
    from pptx_ng.oxml.table import CT_Table, CT_TableCell, CT_TableCol, CT_TableRow
    from pptx_ng.parts.slide import BaseSlidePart
