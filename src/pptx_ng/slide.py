...
from pptx_ng.shared import ElementProxy, ParentedElementProxy, PartElementProxy
from pptx_ng.util import lazyproperty

if TYPE_CHECKING:
    from pptx_ng.oxml.presentation import CT_SlideIdList, CT_SlideMasterIdList
    from pptx_ng.oxml.slide import (
        CT_CommonSlideData,
        CT_NotesSlide,
        CT_Slide,
    ...
    from pptx_ng.shapes.placeholder import LayoutPlaceholder, MasterPlaceholder
    from pptx_ng.shapes.shapetree import NotesSlidePlaceholder
...
class Slide(_BaseSlide):
    ...
    def comments(self):
        ...
        """
        from pptx_ng.comment import Comments
