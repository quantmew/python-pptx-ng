...
from pptx_ng.enum.text import MSO_AUTO_SIZE, MSO_UNDERLINE, MSO_VERTICAL_ANCHOR
from pptx_ng.opc.constants import RELATIONSHIP_TYPE as RT
from pptx_ng.oxml.simpletypes import ST_TextWrappingType
from pptx_ng.shapes import Subshape
from pptx_ng.text.fonts import FontFiles
from pptx_ng.text.layout import TextFitter
from pptx_ng.util import Centipoints, Emu, Length, Pt, lazyproperty

if TYPE_CHECKING:
    from pptx_ng.dml.color import ColorFormat
    from pptx_ng.enum.text import (
        MSO_TEXT_UNDERLINE_TYPE,
        MSO_VERTICAL_ANCHOR,
        PP_PARAGRAPH_ALIGNMENT,
    )
    from pptx_ng.oxml.action import CT_Hyperlink
    from pptx_ng.oxml.text import (
        CT_RegularTextRun,
        CT_TextBody,
    ...
    from pptx_ng.types import ProvidesExtents, ProvidesPart
...
class _Paragraph(Subshape):
    ...
    def add_math(self):
        ...
        """
        from pptx_ng.math import MathFormula
        from pptx_ng.oxml import parse_xml
        from pptx_ng.oxml.math.core import CT_OMath
