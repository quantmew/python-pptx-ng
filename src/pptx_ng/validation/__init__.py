...
from pptx_ng.validation.package_validator import PackageValidator
from pptx_ng.validation.schema import SchemaValidator
from pptx_ng.validation.semantic import SemanticValidator
...
def _default_constraints():
    ...
    from pptx_ng.validation.presentation_constraints import get_default_constraints
