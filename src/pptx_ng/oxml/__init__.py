...
from pptx_ng.oxml.ns import NamespacePrefixedTag
...
from pptx_ng.oxml.action import CT_Hyperlink  # noqa: E402

register_element_cls("a:hlinkClick", CT_Hyperlink)
register_element_cls("a:hlinkHover", CT_Hyperlink)


from pptx_ng.oxml.animation import (  # noqa: E402
    CT_TLAnimate,
    CT_TLAnimateEffect,
    CT_TLBuildList,
    CT_TLBuildParagraph,
...
from pptx_ng.oxml.comment import (  # noqa: E402
    CT_Comment,
    CT_CommentAuthor,
...
from pptx_ng.oxml.customshow import (  # noqa: E402
    CT_CustomShow,
    CT_CustomShowList,
...
from pptx_ng.oxml.handout import (  # noqa: E402
    CT_HandoutMaster,
...
from pptx_ng.oxml.tags import CT_Tag, CT_TagList  # noqa: E402

register_element_cls("p:tag", CT_Tag)
register_element_cls("p:tagLst", CT_TagList)


from pptx_ng.oxml.chartex.chartex import (  # noqa: E402
    CT_ChartEx,
    CT_ChartExData,
    CT_ChartExSpace,
    CT_PlotArea,
...
from pptx_ng.oxml.model3d import (  # noqa: E402
    CT_AmbientLight,
    CT_DirectionalLight,
    CT_Model3D,
    CT_Model3DCamera,
...
from pptx_ng.oxml.chart.axis import (  # noqa: E402
    CT_AxisUnit,
    CT_CatAx,
    CT_ChartLines,
    CT_Crosses,
...
from pptx_ng.oxml.chart.chart import (  # noqa: E402
    CT_Chart,
    CT_ChartSpace,
    CT_ExternalData,
    CT_PlotArea,
...
from pptx_ng.oxml.chart.datalabel import CT_DLbl, CT_DLblPos, CT_DLbls  # noqa: E402
...
from pptx_ng.oxml.chart.legend import CT_Legend, CT_LegendPos  # noqa: E402

register_element_cls("c:legend", CT_Legend)
register_element_cls("c:legendPos", CT_LegendPos)


from pptx_ng.oxml.chart.marker import CT_Marker, CT_MarkerSize, CT_MarkerStyle  # noqa: E402
...
from pptx_ng.oxml.chart.plot import (  # noqa: E402
    CT_Area3DChart,
    CT_AreaChart,
    CT_BarChart,
    CT_BarDir,
...
from pptx_ng.oxml.chart.series import (  # noqa: E402
    CT_AxDataSource,
    CT_DPt,
    CT_Lvl,
    CT_NumDataSource,
...
from pptx_ng.oxml.chart.shared import (  # noqa: E402
    CT_Boolean,
    CT_Boolean_Explicit,
    CT_Double,
    CT_Layout,
...
from pptx_ng.oxml.coreprops import CT_CoreProperties  # noqa: E402

register_element_cls("cp:coreProperties", CT_CoreProperties)


from pptx_ng.oxml.dml.color import (  # noqa: E402
    CT_Color,
    CT_HslColor,
    CT_Percentage,
    CT_PresetColor,
...
from pptx_ng.oxml.dml.fill import (  # noqa: E402
    CT_Blip,
...
from pptx_ng.oxml.dml.line import CT_PresetLineDashProperties  # noqa: E402

register_element_cls("a:prstDash", CT_PresetLineDashProperties)


from pptx_ng.oxml.presentation import (  # noqa: E402
    CT_Presentation,
    CT_SlideId,
    CT_SlideIdList,
...
from pptx_ng.oxml.presprops import (  # noqa: E402
...
from pptx_ng.oxml.viewprops import CT_GridSpacing, CT_ViewProperties  # noqa: E402

register_element_cls("p:gridSpacing", CT_GridSpacing)
register_element_cls("p:viewPr", CT_ViewProperties)


from pptx_ng.oxml.shapes.autoshape import (  # noqa: E402
    CT_AdjPoint2D,
    CT_CustomGeometry2D,
    CT_GeomGuide,
    CT_GeomGuideList,
...
from pptx_ng.oxml.shapes.connector import (  # noqa: E402
    CT_Connection,
    CT_Connector,
...
from pptx_ng.oxml.shapes.graphfrm import (  # noqa: E402
    CT_GraphicalObject,
...
from pptx_ng.oxml.shapes.groupshape import (  # noqa: E402
    CT_GroupShape,
...
from pptx_ng.oxml.shapes.picture import CT_Picture, CT_PictureNonVisual  # noqa: E402
...
from pptx_ng.oxml.shapes.shared import (  # noqa: E402
...
from pptx_ng.oxml.transition import CT_Transition  # noqa: E402

register_element_cls("p:transition", CT_Transition)


from pptx_ng.oxml.slide import (  # noqa: E402
    CT_Background,
...
from pptx_ng.oxml.table import (  # noqa: E402
    CT_Table,
    CT_TableCell,
...
from pptx_ng.oxml.tablestyle import (  # noqa: E402
    CT_TableStyleEntry,
    CT_TableStyleList,
)
...
from pptx_ng.oxml.text import (  # noqa: E402
    CT_RegularTextRun,
    CT_TextBody,
...
from pptx_ng.oxml.diagram.core import (  # noqa: E402
    CT_ColorsDefinition,
    CT_Connection,
    CT_ConnectionList,
    CT_DataModel,
...
from pptx_ng.oxml.math.core import (  # noqa: E402
    CT_OMath,
    CT_OMathAccent,
...
from pptx_ng.oxml.theme import (  # noqa: E402
    CT_BaseStyles,
    CT_ColorScheme,
    CT_FormatScheme,
    CT_FontScheme,
