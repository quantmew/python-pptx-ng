...
from pptx_ng.oxml.simpletypes import ST_SlideId, ST_SlideSizeCoordinate, XsdString
from pptx_ng.oxml.xmlchemy import BaseOxmlElement, RequiredAttribute, ZeroOrMore, ZeroOrOne

if TYPE_CHECKING:
    from pptx_ng.oxml.customshow import CT_CustomShowList
    from pptx_ng.oxml.handout import CT_HandoutMasterIdList
