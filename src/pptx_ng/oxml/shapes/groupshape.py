...
from pptx_ng.enum.shapes import MSO_CONNECTOR_TYPE
...
from pptx_ng.oxml.xmlchemy import BaseOxmlElement, OneAndOnlyOne, ZeroOrOne
from pptx_ng.util import Emu

if TYPE_CHECKING:
    from pptx_ng.enum.shapes import PP_PLACEHOLDER
    from pptx_ng.oxml.shapes import ShapeElement
    from pptx_ng.oxml.shapes.shared import CT_Transform2D
