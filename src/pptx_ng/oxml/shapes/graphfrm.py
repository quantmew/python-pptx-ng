...
from pptx_ng.oxml.chart.chart import CT_Chart
from pptx_ng.oxml.ns import nsdecls
from pptx_ng.oxml.shapes.shared import BaseShapeElement
from pptx_ng.oxml.simpletypes import XsdBoolean, XsdString
from pptx_ng.oxml.table import CT_Table
...
if TYPE_CHECKING:
    from pptx_ng.oxml.shapes.shared import (
