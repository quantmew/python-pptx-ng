...
from pptx_ng.oxml.simpletypes import ST_DrawingElementId, XsdUnsignedInt
from pptx_ng.oxml.xmlchemy import BaseOxmlElement, OneAndOnlyOne, RequiredAttribute, ZeroOrOne

if TYPE_CHECKING:
    from pptx_ng.oxml.shapes.shared import CT_ShapeProperties
