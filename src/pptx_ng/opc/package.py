...
from pptx_ng.opc.oxml import CT_Relationships, serialize_part_xml
from pptx_ng.opc.packuri import CONTENT_TYPES_URI, PACKAGE_URI, PackURI
from pptx_ng.opc.serialized import PackageReader, PackageWriter
...
if TYPE_CHECKING:
    ...
    from pptx_ng.opc.oxml import CT_Relationship, CT_Types
