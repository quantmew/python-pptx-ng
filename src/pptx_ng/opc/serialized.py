...
from pptx_ng.opc.oxml import CT_Types, serialize_part_xml
from pptx_ng.opc.packuri import CONTENT_TYPES_URI, PACKAGE_URI, PackURI
from pptx_ng.opc.shared import CaseInsensitiveDict
from pptx_ng.opc.spec import default_content_types
from pptx_ng.util import lazyproperty

if TYPE_CHECKING:
    from pptx_ng.opc.package import Part, _Relationships  # pyright: ignore[reportPrivateUsage]
