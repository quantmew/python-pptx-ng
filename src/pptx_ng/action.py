...
if TYPE_CHECKING:
    ...
    from pptx_ng.oxml.shapes.shared import CT_NonVisualDrawingProps
    from pptx_ng.oxml.text import CT_TextCharacterProperties
    from pptx_ng.parts.slide import SlidePart
    from pptx_ng.shapes.base import BaseShape
    from pptx_ng.slide import Slide, Slides
