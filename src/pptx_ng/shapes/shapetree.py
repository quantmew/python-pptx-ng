...
from pptx_ng.enum.shapes import PP_PLACEHOLDER, PROG_ID
from pptx_ng.media import SPEAKER_IMAGE_BYTES, Audio, Video
...
from pptx_ng.oxml.simpletypes import ST_Direction
...
from pptx_ng.shared import ParentedElementProxy
from pptx_ng.util import Emu, lazyproperty
...
if TYPE_CHECKING:
    ...
    from pptx_ng.enum.shapes import MSO_CONNECTOR_TYPE, MSO_SHAPE
    ...
    from pptx_ng.slide import Slide, SlideLayout
