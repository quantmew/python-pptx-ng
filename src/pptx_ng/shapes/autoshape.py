...
from pptx_ng.enum.shapes import MSO_AUTO_SHAPE_TYPE, MSO_SHAPE_TYPE
from pptx_ng.shapes.base import BaseShape
from pptx_ng.spec import autoshape_types
from pptx_ng.text.text import TextFrame
from pptx_ng.util import lazyproperty

if TYPE_CHECKING:
    from pptx_ng.oxml.shapes.autoshape import CT_GeomGuide, CT_PresetGeometry2D, CT_Shape
